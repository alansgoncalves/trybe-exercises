...
-- 1. Todos os funcionários foram promovidos a atores. Monte uma query que exiba a 
-- união da tabela staff com a tabela actor , exibindo apenas o nome e o sobrenome. 
...
-- feita de 15 em 15 resultados e que você está na 4ª página. Monte uma query que simule 
-- esse cenário:
(SELECT first_name, last_name FROM sakila.actor ORDER BY first_name, last_name)
UNION
(SELECT first_name, last_name FROM sakila.customer ORDER BY first_name, last_name)
