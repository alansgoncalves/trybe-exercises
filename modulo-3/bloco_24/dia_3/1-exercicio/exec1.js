...
// 6. Retorne todos os filmes com ratings maior do que 103, exibindo apenas
...
// 7. Retorne todos os filmes com ratings entre 100 e 105, exibindo apenas
// os campos title e ratings:
db.movies.find(
  {
    ratings: {
...
// 8. Retorne todos os filmes com ratings entre 64 e 105 e divisíveis por 9,
...
// 12. Busque os filmes em que o módulo 5 do campo budget seja 0 e que o array category
// tenha tamanho 2:
db.movies.find(
  {
    budget: { $mod: [ 5, 0 ] },
...
// 13. Retorne os filmes da categoria "sci-fi" ou que possua o ratings maior do que 199, 
// exibindo apenas os campos title , ratings e category:
db.movies.find(
  {
    $or: [
...
// 14. Retorne os filmes em que o ratings possua tamanho 4 e que seja da category "adventure"
// ou "family" , mas que não tenha o imdbRating menor que 7:
db.movies.find({
  $and: [ 
  { ratings: { $size: 4 } }, 
...
// 15. Adicione o campo description no filme Batman com o seguinte valor: "The Dark Knight
// of Gotham City begins his war on crime with his first major enemy being Jack Napier, a 
// criminal who becomes the clownishly homicidal Joker."
db.movies.updateOne(
  { title: "Batman" },
  {
...
// 16. Adicione o campo description no filme Godzilla com o seguinte valor: "The world is beset
// by the appearance of monstrous creatures, but one of them may be the only one who can save humanity.":
db.movies.updateOne(
  { title: "Godzilla" },
  {
...
// 17. Adicione o campo description no filme Home Alone com o seguinte valor: "An eight-year-old
// troublemaker must protect his house from a pair of burglars when he is accidentally left home 
