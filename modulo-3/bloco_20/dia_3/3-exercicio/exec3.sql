...
-- 3. Usando a tabela rental , extraia data, ano, mês, dia, hora, minuto e segundo do 
-- registro com rental_id = 10330. Utilize a coluna rental_date para extrair as informações.
SELECT * FROM rental;
-- Aqui, o SQL retorna somente uma coluna
SELECT TIMESTAMP(rental_date) FROM rental WHERE rental_id = 10330;
-- Aqui, o SQL retorna 7 colunas
