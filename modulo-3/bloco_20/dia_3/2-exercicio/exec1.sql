...
WHERE customer_id IN(172, 173, 174, 175, 176)
ORDER BY email;
...
SELECT * FROM payment;
SELECT COUNT(*) AS total_payed FROM payment WHERE payment_date BETWEEN '2005-05-01'AND '2005-08-01';
...
-- filmes com maior duração de empréstimo primeiro. Em caso de empate, ordene em ordem alfabética pelo título.
