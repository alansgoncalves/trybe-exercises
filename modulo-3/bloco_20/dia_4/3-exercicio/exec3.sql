...
VALUES ('Monstros SA', 'Pete Docter', 2001, 92),
       ...
       ('Os Incríveis, de Brad Bird', NULL, 2004, 116),
...
-- 4. O título do filme "Ratatouille" esta escrito de forma incorreta na tabela Movies , além disso, o filme foi lançado em 2007 e não em 2010. 
...
-- 5. Insira as novas classificações abaixo na tabela BoxOffice , lembre-se que a coluna movie_id
...
DELETE FROM BoxOffice WHERE movie_id = 11; -- este é o id do filme WALL-E
